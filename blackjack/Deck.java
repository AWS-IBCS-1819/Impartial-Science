...
public class Deck {
  ...
  ArrayList<Card> cards;// a bunch of card object (main deck)
  ...
  public void shuffle() {
    ...
    int[] ar = r.ints(5200, 0, 52).distinct().toArray();//creat a int array with all the distinct int between 0 and 51
    for (int i = 0; i < 52; i ++) {
  ...
  public Deck() {
    ...
    for (int i = 1; i <= 13; i++) {
      for (int j = 1; j <= 4; j++) {
        ...
        Card c = new Card();//each time you draw a card from random shuffle, you have to name it and put it in the main deck
