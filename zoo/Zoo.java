...
public class Zoo {
  ...
  public static String noFormat(String before){//change the format of user's input
  ...
  public static void chooseAnimalActionsZookeeper(Animal animal){//zookeeper
    ...
    Scanner sc1 = new Scanner(System.in);// scanner for user's option
    ...
    }else if (todo.equals("5")||todo.equals("6")||todo.equals("7")||todo.equals("8")) {//if they want to change something
      System.out.println("What do you want to change it to?");
      Scanner sc2 = new Scanner(System.in);
      String userChange = sc2.next();//change to the user's input

      if (todo.equals("5")) {//then print out the new name
  ...
  public static void chooseAnimalActionsVisitor(Animal animal){//visitor
    System.out.println("What do you want to do with that animal?");
    System.out.println("1. view its name");
    System.out.println("2. view its weight");
    System.out.println("3. view its color");
